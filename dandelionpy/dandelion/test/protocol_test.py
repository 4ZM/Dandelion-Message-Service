...
class ProtocolTest(unittest.TestCase):
    ...
    def test_roundtrip_message_id_list(self):
        ...
        ts = 1337
        msg1 = Message('M1')
        msg2 = dandelion.message.create('M2', ts, id1, id2)
        msg3 = dandelion.message.create('M3', ts, id1)
        msg4 = dandelion.message.create('M3', ts, None, id2)
    ...
    def test_create_message_list(self):
        ...
        m2 = Message('f00')
        m3 = Message('13;@|37')
        m4 = dandelion.message.create('fu', ts, id1, id2)
        m1_txt_b64 = 'RlVCQVI='
        m2_txt_b64 = 'ZjAw'
    ...
    def test_message_list_roundtrip(self):
        ...
        m2 = dandelion.message.create('M2', timestamp=2, sender=id1)
        m3 = dandelion.message.create('M3', timestamp=3, receiver=id1)
        m4 = dandelion.message.create('M4', timestamp=4, receiver=id1, sender=id2)
